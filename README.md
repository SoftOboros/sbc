...
There are now 59 core tests and 62 Git/provenance tests; these are bounded
...
Generated bytes are not a validated snapshot or publication candidate. Source
selection/order, family assignment, complete source inventory, bundle validation
and admitted-source wiring remain before the portable scan path is runnable.
